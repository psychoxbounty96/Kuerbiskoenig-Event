...
export const INITIAL_EVENT_STATE: EventState = {
  ...
  passiveDamage: {
    id: null, streamerId: null, bucketStartedAt: null, mode: "test", viewerEstimate: null,
    sampleCount: 0, configuredDamage: 0, appliedDamage: 0, status: "none", skipReason: null,
    configurationVersion: 1, processedAt: null,
  },
  jobs: [],
  calibration: {
    streamers: [], includedStreamers: 0, totalSamples: 0, projectedPassiveDamage: 0,
    projectedPassiveDamagePerHour: 0, maxConcurrentStreamers: 0,
