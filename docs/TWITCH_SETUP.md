...
`NEXT_PUBLIC_DATA_PROVIDER=supabase` und den gewünschten Eventslug setzen. Auf `/` müssen mehrere aktive Streamer gleichzeitig `LIVE` und ihre aggregierte Zuschauerzahl zeigen. Deaktivierte Streamer dürfen nicht erscheinen.
